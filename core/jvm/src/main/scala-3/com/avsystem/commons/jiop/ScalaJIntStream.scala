...
final class ScalaJIntStream(private[jiop] val jStream: JIntStream) extends AnyVal {
  ...
  inline def collect[R](inline supplier: => R)(inline accumulator: (R, Int) => Any, inline combiner: (R, R) => Any): R =
